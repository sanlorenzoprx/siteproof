...
export const REPORT_DEFINITIONS: Record<(typeof APP_REPORT_TYPES)[number], ReportDefinition> = {
  [SiteProofReportType.CUSTOMER_COMPLETION]: {
    ...
    audience: 'customer',
    purpose: 'Customer-facing closeout packet with completed work, safe notes, and polished proof.',
  ...
  [SiteProofReportType.INSPECTION_READINESS]: {
    ...
    audience: 'inspector',
    purpose: 'Inspection-ready evidence package focused on required proof, checklist status, GPS, and timestamps.',
  ...
  [SiteProofReportType.CHANGE_ORDER_EVIDENCE]: {
    ...
    purpose: 'Focused proof packet for documented scope changes, issues, hidden conditions, and customer-requested changes.',
